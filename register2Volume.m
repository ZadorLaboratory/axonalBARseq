% Previous name: wholeBrainBC_1h, 03272022
...
% Align tiles, using pixel corrected images
...
% Mannual correciton/exclusion (not able to align)
...
% Mannually select the section to start (align this and the later)
startSeq = 1;

% Note: the transormation matrix and displacement field were scaled
...
% To mannually correct errors during the self-alignment
